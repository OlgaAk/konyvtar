...
def get_dummy_books() -> list[Book]: 
    ...
    printedBook3 = PrintedBook(f'Lejár: 2025.12.31', 'KK Sárkányos Gyerekkönyvtár, 1. szint')
    ...
    printedBook6 = PrintedBook(f'Lejár: 2025.12.31', 'KK Sárkányos Gyerekkönyvtár, 1. szint')
    ...
    printedBook9 = PrintedBook(f'Lejár: 2025.12.31', 'KK Sárkányos Gyerekkönyvtár, 1. szint')
    ...
    printedBook12 = PrintedBook(f'Lejár: 2025.12.31', 'KK Sárkányos Gyerekkönyvtár, 1. szint')
